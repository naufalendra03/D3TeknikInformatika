        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-12 lg:px-6">
            ...
            <div class="grid max-w-screen-lg gap-8 mx-auto text-primary-700 sm:grid-cols-4">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <dd class="font-light text-gray-500 dark:text-gray-400">Akreditasi</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="text-4xl mb-0 md:mb-2 md:text-5xl font-extrabold">50+</dt>
                    <dd class="font-light text-gray-500 dark:text-gray-400">Mahasiswa</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="text-4xl mb-0 md:mb-2 md:text-5xl  font-extrabold">6</dt>
                    <dd class="font-light text-gray-500 dark:text-gray-400">Tenaga Pengajar</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="text-4xl mb-0 md:mb-2 md:text-5xl  font-extrabold">200+</dt>
                    <dd class="font-light text-gray-500 dark:text-gray-400">Lulusan</dd>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:px-6">
            ...
            <div class="grid gap-8 lg:grid-cols-3">
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md">
                    ...
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 e"><a href="#">How to quickly deploy a static website</a></h2>
