<x-layout >
    ...
    <section class="">
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-12 lg:px-6">
            ...
            <div class="grid max-w-screen-lg gap-8 mx-auto text-primary-700 sm:grid-cols-4">
                ...
                <div class="flex flex-col items-center justify-center">
                    <dt class="text-4xl mb-0 md:mb-2 md:text-5xl font-extrabold">50+</dt>
    ...
    <section class="">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0 bg-primary-600 p-8 rounded-lg">
                <div class="flex flex-col items-center justify-center text-center md:items-start md:justify-start md:text-start">
                    ...
                    <p class="text-gray-300 text-justify">profesional yang bertanggung jawab untuk merancang, mengembangkan, dan memelihara situs web. Mereka menggunakan bahasa pemrograman, teknologi web, dan alat pengembangan untuk membuat tampilan dan fungsi yang sesuai dengan kebutuhan klien atau proyek.</p>
                </div>
                <div class="flex flex-col items-center justify-center text-center md:items-start md:justify-start md:text-start">
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                    ...
                    <p class="text-gray-300 text-justify">profesional yang bertanggung jawab untuk merancang, mengembangkan, dan memelihara aplikasi yang dirancang khusus untuk berjalan pada perangkat mobile, seperti ponsel cerdas (smartphones) dan tablet.</p>
                </div>
                <div class="flex flex-col items-center justify-center text-center md:items-start md:justify-start md:text-start">
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                    ...
                    <p class="text-gray-300 text-justify">Profesional yang bertanggung jawab untuk merancang, mengelola, dan memelihara jaringan komputer dalam suatu organisasi. Tugas-tugas seorang network engineer mencakup: Desain Jaringan, Konfigurasi dan Pemasangan Perangkat Jaringan, Keamanan Jaringan, Dll.</p>
                </div>
                <div class="flex flex-col items-center justify-center text-center md:items-start md:justify-start md:text-start">
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                    ...
                    <p class="text-gray-300 text-justify">profesional yang bertanggung jawab untuk mengelola dan menjaga infrastruktur teknis serta konten suatu situs web. Tugas-tugas seorang web administrator mencakup: Pengelolaan Server, Konfigurasi dan Pemeliharaan Perangkat Lunak, Keamanan, Pemulihan Bencana, Manajemen Konten, Pemantauan Lalu Lintas, Dukungan Pengguna.</p>
                </div>
                <div class="flex flex-col items-center justify-center text-center md:items-start md:justify-start md:text-start">
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                    ...
                    <p class="text-gray-300 text-justify">Profesional IT yang bertanggung jawab untuk mengelola dan memelihara basis data (database) sebuah organisasi. Tugas-tugas seorang DBA mencakup: Desain Basis Data, Instalasi dan Konfigurasi, Keamanan Data, Dll.</p>
                </div>
                <div class="flex flex-col items-center justify-center text-center md:items-start md:justify-start md:text-start">
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:px-6">
            ...
            <div class="grid gap-8 lg:grid-cols-3">
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md">
                    ...
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 e"><a href="#">How to quickly deploy a static website</a></h3>
    ...
    <section class="">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:px-6">
            ...
            <div class="grid gap-8 lg:grid-cols-3">
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md">
                    <img class="h-auto max-w-full rounded-lg mb-2" src="{{asset('img/WLP.jpg')}}" alt="image description">
                    ...
                    <h3 class=" text-2xl font-bold tracking-tight text-gray-900 e"><a href="#">How to quickly deploy a static website</a></h3>
                
                </article> 
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md">
                    <img class="h-auto max-w-full rounded-lg mb-2" src="{{asset('img/uiux.jpg')}}" alt="image description">
                    <div class="flex justify-between items-center mb-2 text-gray-500">
                        {{-- <span class="bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded ">
                    ...
                    <h3 class=" text-2xl font-bold tracking-tight text-gray-900"><a href="#">How to quickly deploy a static website</a></h3>
